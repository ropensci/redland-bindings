...
int librdf_model_load(librdf_model* model, librdf_uri *uri, const char* name=NULL, const char* mime_type=NULL, librdf_uri *type_uri=NULL);
...
char* librdf_model_to_string(librdf_model* model, librdf_uri *uri /* or NULL */, const char* name=NULL /* */ , const char* mime_type=NULL, librdf_uri* inUriOrNull /*type_uri */ =NULL);
