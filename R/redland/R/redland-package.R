...
#' 
#' The relationship between the Redland C library and the redland R package is shown in the following table:
#' \tabular{llll}{
...
#' Digest\tab librdf_digest\tab Not implemented\tab Internal content digest class\cr
#' Hash\tab librdf_hash\tab Not implemented\tab Internal key:value maps class
#' }
#' 
#' It is recommended that the redland package R clasess be used, however, all of the R interface functions generated by SWIG are made available
...
#' for the R interface functions can be found via R help i.e. \code{'?librdf_iterator'}. Documentation for the redland R package
