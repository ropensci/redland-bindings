...
#' @examples
#' \dontrun{
#' node <- new("Node", world) # a blank node is created with a unique identifier generated by librdf
#' node <- new("Node", world, blank=NULL) # a blank node is created with a unique identifier generated by librdf
#' node <- new("Node", world, blank="someid") # a blank node is created with the user specified identifier, i.e. "_:id1"
