...
#' @export
roclet_process.roclet_mergeNamespace <- function(roclet, partita, base_path, global_options = list()) {
...
#' @param ... additional parameters
#' @export
roclet_output.roclet_mergeNamespace <- function(roclet, results, base_path, ...) {
